...
<div class="box box-widget">
  <div class="box-header with-border">
    <div class="user-block">
      ...
      @if($work->userAvatar->profile_image)
        src="/uploads/profileimage/{{$work->userAvatar->profile_image}}"
      @else
          src="/frontend/img/Profile/default-avatar.png"
      @endif
       alt="">
      <span class="username"><a href="{{route('userProfile')}}?id={{$work->userid}}">{{$work->userAvatar->first_name}} {{$work->userAvatar->last_name}}</a></span>
