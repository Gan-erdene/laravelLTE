...
@else
<i data-propid="{{$pid}}" data-userid="{{$user_id}}" data-id="1" class="fa fa-star fa-lg setrate"></i>
<i data-propid="{{$pid}}" data-userid="{{$user_id}}" data-id="2"  class="fa fa-star fa-lg setrate"></i>
<i data-propid="{{$pid}}" data-userid="{{$user_id}}" data-id="3" class="fa fa-star fa-lg setrate"></i>
<i data-propid="{{$pid}}" data-userid="{{$user_id}}" data-id="4" class="fa fa-star fa-lg setrate"></i>
<i data-propid="{{$pid}}" data-userid="{{$user_id}}" data-id="5" class="fa fa-star fa-lg setrate"></i>
@endif
